...
% process input arguments
 ...
 if doPlot(1)
   ...
   figure(1); print -dpng fdRhoBox; close;
 ...
 if doPlot(2)
   ...
   figure(2); print -dpng fdPost; close;
 end    
 ...
 if doPlot(3)    
   ...
   figure(3); print -dpng fdPreds; close;
 end
 ...
 if doPlot(4)
   ...
   % save some plots
   figure(37); print -dpng surf212.png;
   figure(36); print -dpng surf112.png;
   figure(33); print -dpng surf313.png;
   figure(34); print -dpng surf413.png;
   figure(35); print -dpng surf513.png;
 end
